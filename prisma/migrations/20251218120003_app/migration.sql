...
CREATE TABLE `shares` (
    ...
    UNIQUE INDEX `shares_videoId_sharerId_key`(`videoId`, `sharerId`),
    PRIMARY KEY (`id`)
) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci;
...
-- AddForeignKey
ALTER TABLE `videos` ADD CONSTRAINT `videos_originalPostId_fkey` FOREIGN KEY (`originalPostId`) REFERENCES `videos`(`id`) ON DELETE SET NULL ON UPDATE CASCADE;
