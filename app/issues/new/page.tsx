  ...
  return (
    <div className="bg-white shadow-md p-6 text-black max-w-xl mx-auto rounded-lg mt-10">
      ...
      <form onSubmit={handleSubmit} className="space-y-4">
        ...
        <button
          type="submit"
          className={` ${loading?"bg-blue-600 hover:bg-blue-700":"bg-blue-400 hover:bg-blue-500"} w-full  text-white font-semibold py-2 px-4 rounded-md transition duration-200`}
        >
         {loading?<p>Posting...</p>:<>Post</>}
        </button>
      </form>
    </div>
  );
