    ...
    <div>
        ...
        <div className="max-w-md w-full bg-white rounded-xl shadow-lg p-8 space-y-6">
            ...
            <div>
                ...
                required
                className="w-full px-4 py-2 border rounded-lg focus:outline-none focus:ring-2 focus:ring-fuchsia-500 focus:border-fuchsia-500"
                />
            </div>
            <button
                type="submit"
                ...
                pending ? "bg-fuchsia-300 cursor-not-allowed" : "bg-fuchsia-600 hover:bg-fuchsia-700"
                }`}
            >
